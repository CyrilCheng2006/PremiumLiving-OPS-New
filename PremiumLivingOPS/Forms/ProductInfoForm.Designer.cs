...
partial class ProductInfoForm
{
    ...
    private void InitializeComponent()
    {
        ...
        lblTitle  = new Label { Text = "📦 Product Information", Font = UITheme.FontTitle, ForeColor = UITheme.TextDark, AutoSize = true, Location = new Point(0, 8) };
        txtSearch = new TextBox { PlaceholderText = "Search Product…", Size = new Size(220, 28), Location = new Point(420, 14) };
        ...
        btnNew = new Button { Text = "+ New Product", Size = new Size(120, 28), Location = new Point(736, 14), BackColor = UITheme.AccentGold, ForeColor = UITheme.PrimaryDark, FlatStyle = FlatStyle.Flat, Cursor = Cursors.Hand };
        ...
        dgv.Columns.AddRange(new DataGridViewColumn[] {
            ...
            new DataGridViewTextBoxColumn { HeaderText = "Category",      Name = "Category" },
            new DataGridViewTextBoxColumn { HeaderText = "Unit Price",    Name = "Price" },
            new DataGridViewTextBoxColumn { HeaderText = "Stock Qty",     Name = "Stock" },
